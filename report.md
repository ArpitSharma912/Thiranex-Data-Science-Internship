...
# Day 1
### Objective
Understand the dataset and prepare it for exploratory analysis
### Work Completed
...
- Created a dataset summary table.

### Learning Outcomes
- Learned how to inspect a dataset before analysis.
- Understood the importance of identifying data types and missing values.

# Day 2
## Objective
Perform univariate analysis on individual features of the Titanic dataset.

## Work Completed
- Analyzed survival distribution.
- Analyzed passenger class.
- Analyzed gender distribution.
- Analyzed age distribution.
- Analyzed fare distribution.
- Analyzed embarkation ports.

## Learning Outcomes
- Learned how to analyze a single variable.
- Understood categorical and numerical distributions.
- Learned to calculate percentages and interpret graphs.

# Day 3
## Objective
Perform bivariate analysis to study relationships between two variables.

## Work Completed
- Analyzed survival by gender.
- Analyzed survival by passenger class.
- Compared age with survival.
- Compared fare with survival.
- Studied embarkation port versus survival.
- Generated a correlation heatmap.

## Learning Outcomes
- Learned how to compare categorical variables.
- Understood how boxplots reveal differences between groups.
- Learned to interpret relationships using correlation.

# Day 4
## Objective
Perform multivariate analysis and summarize key insights.

## Work Completed
- Created pairplot.
- Generated survival heatmap by gender and passenger class.
- Compared average fare by passenger class.
- Compared average age by passenger class.
- Analyzed the top 10 highest fares.
- Documented overall insights.

## Learning Outcomes
- Learned to analyze relationships among multiple variables.
- Used pivot tables and groupby operations.
- Created advanced visualizations.
- Drew meaningful conclusions from the dataset.

## Conclusion
The Exploratory Data Analysis revealed important relationships between passenger characteristics and survival. Gender, passenger class, and fare were found to be the strongest factors associated with survival.